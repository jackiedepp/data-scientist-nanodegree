...
def load_data(messages_filepath, categories_filepath):
    ...
    Parameters:
        messages_filepath: file path of massages dataset
        categories_filepath: file path of categories dataset
        
    Returns:
        df: dataframe of measseges and categories
    '''
...
def clean_data(df):
    '''
    Clean data: Split categories into seperate category columns;
...
def save_data(df, database_filename):
    ...
    Parameters:
        df: the data to be saved
        database_filename: file name of database storing df
